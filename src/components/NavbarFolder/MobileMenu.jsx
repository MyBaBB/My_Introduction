...
const MobileMenu = () => {
  return (
    <div className="m-auto">
      <div
        className="hidden-square top-68   animate-open-menu w-full origin-top flex-col 
                    items-center justify-center bg-black text-center font-Orbitron"
        style={{
      ...
      >
        ...
        {/* <div
        className="mx-4 -mt-10 rounded-xl border-[1px] border-varMEDBLUEFEATHER
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span
                className="font-Kingthings whitespace-nowrap
                           text-[2.2rem] xs:text-[3rem] p-2"
              >
                Customized Websites
              </span>
            </h2>
