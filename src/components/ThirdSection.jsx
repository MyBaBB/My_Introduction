    ...
    <div>
       <section  className='pl-8'>
            ...
            text-[12px] xxs:text-[19px] xs:text-[23px] sm:text-[20px] md:text-[23px] ">
                <li><IoBookSharp className='inline-block text-blue-400' />&nbsp;&nbsp;&nbsp;React Js.</li>
                <li><IoBookSharp className='inline-block text-blue-400' />&nbsp;&nbsp;&nbsp;HTML5</li>
                <li><IoBookSharp className='inline-block text-blue-400' />&nbsp;&nbsp;&nbsp;CSS3</li>
                <li><IoBookSharp className='inline-block text-blue-400' />&nbsp;&nbsp;&nbsp;Tailwind CSS</li>
                <li><IoBookSharp className='inline-block text-blue-400' />&nbsp;&nbsp;&nbsp;JavaScript</li>
